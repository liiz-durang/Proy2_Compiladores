...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_CADENA (location_type l)
      {
        return symbol_type (token::CADENA, std::move (l));
      }
#else
      static
      symbol_type
      make_CADENA (const location_type& l)
      {
        return symbol_type (token::CADENA, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CARACTER (location_type l)
      {
        return symbol_type (token::CARACTER, std::move (l));
      }
#else
      static
      symbol_type
      make_CARACTER (const location_type& l)
      {
        return symbol_type (token::CARACTER, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::DIF, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::DIF, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_MENORI (location_type l)
      {
        return symbol_type (token::MENORI, std::move (l));
      }
#else
      static
      symbol_type
      make_MENORI (const location_type& l)
      {
        return symbol_type (token::MENORI, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_MAYORI (location_type l)
      {
        return symbol_type (token::MAYORI, std::move (l));
      }
#else
      static
      symbol_type
      make_MAYORI (const location_type& l)
      {
        return symbol_type (token::MAYORI, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
